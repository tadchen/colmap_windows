...
############################################ set dependencies ############################################
set(CMAKE_MODULE_PATH "Z:/Eigen3_vcpkg/share/eigen3" ${CMAKE_MODULE_PATH}) #Eigen3Config.cmake
set(Eigen3_DIR "Z:/Eigen3_vcpkg/share/eigen3")
find_package(Eigen3 REQUIRED)
message("Eigen3 include dir: ${EIGEN3_INCLUDE_DIRS}")
list(APPEND CMAKE_PREFIX_PATH "Z:/boost_vcpkg")
list(APPEND CMAKE_PREFIX_PATH "Z:/CGAL_vcpkg")
...
list(APPEND CMAKE_PREFIX_PATH "Z:/metis_vcpkg")
...
message("GLOG_VERSION_MAJOR:${glog_VERSION_MAJOR}")
message("GLOG_VERSION_MINOR:${GLOG_VERSION_MINOR}")
...
# list(APPEND CMAKE_PREFIX_PATH "Z:/ceres_vcpkg/share/gflags")
# find_package(gflags CONFIG REQUIRED)


list(APPEND CMAKE_PREFIX_PATH "Z:/ceres_vcpkg")
set(GFLAGS_USE_TARGET_NAMESPACE TRUE)
find_package(Ceres REQUIRED)
if(TARGET gflags::gflags)
    message(STATUS "gflags::gflags target found ✅")
else()
    message(FATAL_ERROR "gflags::gflags target not found ❌")
endif()
